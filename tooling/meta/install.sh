...
echo ""
echo "Get started:"
echo "  meta init       # Initialize meta.toml in your monorepo"
echo "  meta dev        # Start all development servers"
echo "  meta tui        # Interactive TUI with log streaming"
echo ""
echo "For more information:"
echo "  meta --help"
echo "  https://github.com/wolven-tech/rust-v1/tree/main/tooling/meta"
echo ""
